...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "file", type=str, help="Path to the npz file containing the points"
    )
    ...
    for point in rasterised_points:
        ...
        draw.ellipse(
            [
                clear[0] - crisp_radius,
                clear[1] - crisp_radius,
                clear[0] + crisp_radius,
                clear[1] + crisp_radius,
            ],
            fill=(230, 255, 255, 200),
        )
    ...
    for point in rasterised_points:
        ...
        for r in range(fuzzy_radius):
            ...
            draw.ellipse(
                ...
                fill=(0, 255, 255, int(255 * (1 - r / fuzzy_radius))),
            )
